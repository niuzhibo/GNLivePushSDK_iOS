...
/**
 ...
 display with GNYYAnimatedImageView.
 
 Subclass a UIImage and implement this protocol, so that instances of that class 
 can be set to GNYYAnimatedImageView.image or GNYYAnimatedImageView.highlightedImage
 to display animation.
 
 See `GNYYImage` and `GNYYFrameImage` for example.
 */
@protocol GNYYAnimatedImage <NSObject>
@required
